- view: session_pageview_hours
  sql_table_name: public.session_pageview_hours
  fields:
  ...
  - dimension: min_request_remote_ip
    sql: ${TABLE}.min_request_remote_ip
  ...
  - dimension: num_request_remote_ip
    type: number
    sql: ${TABLE}.num_request_remote_ip
